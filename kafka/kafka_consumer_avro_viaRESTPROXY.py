# This script shows how to write a consumer program to consume avro data via REST PROXY
import asyncio
...
async def consume():
    ...
    while True:
        ...
        resp = requests.get(f"{resp_data['base_uri']}/records?timeout=100", headers=headers)
        try:
            resp.raise_for_status()
        except:
            print(
