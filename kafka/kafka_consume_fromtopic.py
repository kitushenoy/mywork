###
### This script produces messages automatically and demonstrates how to read the message using consumer function consume. 
####Consumer can read more than 1 message where as poll function can read only one hence do not use for loop for poll
###
...
def main():
    ...
    print("client is created in main")
    try:
