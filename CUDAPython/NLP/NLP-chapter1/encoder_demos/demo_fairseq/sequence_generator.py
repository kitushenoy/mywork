...
from encoder_demos.demo_fairseq import utils
from encoder_demos.demo_fairseq.models import FairseqIncrementalDecoder

# from encoder_demos.demo_fairseq.models.fairseq_incremental_decoder import FairseqIncrementalDecoder
# from encoder_demos.demo_fairseq.models.fairseq_encoder import FairseqEncoder
# from encoder_demos.demo_fairseq.models.transformer import TransformerModel
# from encoder_demos.demo_fairseq.models.composite_encoder import CompositeEncoder
# from encoder_demos.demo_fairseq.models.fairseq_model import BaseFairseqModel
...
class SequenceGenerator(object):
    ...
    def generate(self, src_tokens, src_lengths, beam_size=None, maxlen=None, prefix_tokens=None, return_early=None):
        """Generate a batch of translations."""

        with torch.no_grad():
            return self._generate(src_tokens, src_lengths, beam_size, maxlen, prefix_tokens, return_early=return_early)

    def _generate(self, src_tokens, src_lengths, beam_size=None, maxlen=None, prefix_tokens=None, return_early=None):
        """
        :param return_early: Added to return early with a piece of information, as specified by return_early.
        Default return_early == None, therefore continue as normal.
        """
        ...
        for model in self.models:
            ...
            if return_early in ['embed_scale', 'self_attn']:
                return encoder_out
